...
-- 正在傾印表格  ceweb.carousel 的資料：~9 rows (近似值)
...
INSERT INTO `carousel` (`id`, `url`, `href`, `enable`, `mods`) VALUES
	...
	(6, 'http://ce.ntpu.edu.tw/images/image.png', '', 1, '16'),
...
-- 正在傾印表格  ceweb.ce_admin 的資料：~1 rows (近似值)
...
CREATE TABLE IF NOT EXISTS `ga_item` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=83 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Item of ga_topic';

-- 正在傾印表格  ceweb.ga_item 的資料：~82 rows (近似值)
...
CREATE TABLE IF NOT EXISTS `ga_topic` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Here record topic for ga_item to group same topic events.';

-- 正在傾印表格  ceweb.ga_topic 的資料：~6 rows (近似值)
...
CREATE TABLE IF NOT EXISTS `post` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=73 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='If ''href'' is not NULL, it redirect to the url. ';

-- 正在傾印表格  ceweb.post 的資料：~66 rows (近似值)
