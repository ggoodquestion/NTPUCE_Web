...
CREATE TABLE IF NOT EXISTS `carousel` (
  ...
  `url` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0',
  `href` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '',
  `enable` tinyint(1) NOT NULL DEFAULT '1',
  `mods` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
INSERT INTO `carousel` (`id`, `url`, `href`, `enable`, `mods`) VALUES
	...
	(2, 'http://ce.ntpu.edu.tw/images/108學年度通訊系專題展海報.jpg', 'http://www.ce.ntpu.edu.tw/mods/gallery/index.php?topic=6', 0, '16'),
	...
	(10, 'http://ce.ntpu.edu.tw/images/專題.jpg', '', 1, '16'),
	(11, 'http://ce.ntpu.edu.tw/images/專題展_190627_0024.jpg', '', 1, '16');
...
CREATE TABLE IF NOT EXISTS `document` (
  `id` smallint NOT NULL AUTO_INCREMENT,
  `path` varchar(80) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ga_item` (
  ...
  `content` varchar(25) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '0',
  `cover` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `href` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `topic` tinyint NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=96 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Item of ga_topic';
...
INSERT INTO `ga_item` (`id`, `title`, `content`, `cover`, `href`, `topic`) VALUES
	...
	(70, '聲音解鎖器', '626e794c02ea1', 'http://ce.ntpu.edu.tw/images/PRJ-Post-NTPUCE  108-03_page-0001.jpg', NULL, 6),
	(71, '中文語音偵測評分系統', '626e79659456d', 'http://ce.ntpu.edu.tw/images/PRJ-Post-NTPUCE  108-04_page-0001.jpg', NULL, 6),
	(72, '智慧家庭之防盜與火災監視器', '626e7995b3847', 'http://ce.ntpu.edu.tw/images/PRJ-Post-NTPUCE  108-05_page-0001.jpg', NULL, 6),
	(73, '聲控車與通訊技術 Voice control car and Communication Technology', '626e79cad16a0', 'http://ce.ntpu.edu.tw/images/PRJ-Post-NTPUCE  108-06_page-0001.jpg', NULL, 6),
	(74, '無限影分聲之術 Technique of wireless audio & video - visible light communication', '626e7a2885b5b', 'http://ce.ntpu.edu.tw/images/PRJ-Post-NTPUCE  108-07_page-0001.jpg', NULL, 6),
	(75, 'Arduino自動灑水器 Campus automatic sprinkler', '626e7a6e12c76', 'http://ce.ntpu.edu.tw/images/PRJ-Post-NTPUCE  108-08_page-0001.jpg', NULL, 6),
	...
	(77, '防疫用口罩辨識系統', '626e7afd64036', 'http://ce.ntpu.edu.tw/images/PRJ-Post-NTPUCE  108-10_page-0001.jpg', NULL, 6),
	...
	(79, '智慧交通 - 以遊樂園巡迴車為例', '626e7b54bbfad', 'http://ce.ntpu.edu.tw/images/PRJ-Post-NTPUCE  108-12_page-0001.jpg', NULL, 6),
	(80, '無限鼠光 Infinite Light Mouse', '626e7b7b33e19', 'http://ce.ntpu.edu.tw/images/PRJ-Post-NTPUCE  108-13_page-0001.jpg', NULL, 6),
	(81, '行動行動裝置的即時文字辨識與遠端顯示 Mobile device real-time optical character recognition and remote display', '626e7bcb4c927', 'http://ce.ntpu.edu.tw/images/PRJ-Post-NTPUCE  108-14_page-0001.jpg', NULL, 6),
	(82, '智慧飲水機', '626e7be4afbb3', 'http://ce.ntpu.edu.tw/images/PRJ-Post-NTPUCE  108-15_page-0001.jpg', NULL, 6),
	(83, '全雙工自我恢復光纖傳輸器', '628df2ae9df7e', 'http://ce.ntpu.edu.tw/images/Screenshot 2022-05-25 165620.png', 'https://drive.google.com/file/d/1aMwKfspOIj3LKwo3Z7B2YcC_Ok0mOPqL/view?usp=sharing', 7),
	(84, '多臂吃角子老虎機於移動邊緣計算之應用', '628df2cd3f34e', 'http://ce.ntpu.edu.tw/images/Screenshot 2022-05-25 165736.png', 'https://drive.google.com/file/d/1kr90-WMX5yNMaZ69KKhibEKfQQFIpazY/view?usp=sharing', 7),
	(85, '自動籃球追蹤攝影機', '628df46440cf2', 'http://ce.ntpu.edu.tw/images/Screenshot 2022-05-25 165836.png', 'https://drive.google.com/file/d/1LV9Rvd_5vhPjWIuVopuVP_HGMF3o-Sjm/view?usp=sharing', 7),
	(86, '利用Qlearning的方式解決交通路口問題', '628df47d160f7', 'http://ce.ntpu.edu.tw/images/Screenshot 2022-05-25 165908.png', 'https://drive.google.com/file/d/1z_ERM64SZdLfKx1d9jkFc2iyLhGSzvot/view?usp=sharing', 7),
	(87, '空氣盒子', '628df4901d953', 'http://ce.ntpu.edu.tw/images/Screenshot 2022-05-25 165938.png', 'https://drive.google.com/file/d/1TBRN8MkEZ73VQyWVbceLDmqiuKoan1ba/view?usp=sharing', 7),
	(88, '哈囉!Ciao Ciao!', '628df4b5e6866', 'http://ce.ntpu.edu.tw/images/Screenshot 2022-05-25 170016.png', 'https://drive.google.com/file/d/1gFH7JLV0muQxZflwEZ0KV_i7BR3mDY18/view?usp=sharing', 7),
	(89, '音頻處理與應用', '628df4cdedf7f', 'http://ce.ntpu.edu.tw/images/Screenshot 2022-05-25 170141.png', 'https://drive.google.com/file/d/1Ey0C8RcwY_ZcvnGK-Beclzu6S-8gC26D/view?usp=sharing', 7),
	(90, '基於TTS參數之低位元語音壓縮編碼傳輸格式', '628df4e822b10', 'http://ce.ntpu.edu.tw/images/Screenshot 2022-05-25 170216.png', 'https://drive.google.com/file/d/19QrqBNdoiWuYPb9hiN1xOP1iQSlHGOA6/view?usp=sharing', 7),
	(91, '智慧門鎖', '628df4fb54bb7', 'http://ce.ntpu.edu.tw/images/Screenshot 2022-05-25 170302.png', 'https://drive.google.com/file/d/10QBV8mff3j8SbU8ih8yxXPm_v7U9WFSi/view?usp=sharing', 7),
	(92, '智慧型平台', '628df512ae064', 'http://ce.ntpu.edu.tw/images/Screenshot 2022-05-25 170328.png', 'https://drive.google.com/file/d/1WQNAGZz3ejxURxp0Mk7pWP-8pWgPC3TJ/view?usp=sharing', 7),
	(93, '雷射光纖傳輸系統', '628df529b4959', 'http://ce.ntpu.edu.tw/images/Screenshot 2022-05-25 170401.png', 'https://drive.google.com/file/d/16SoAB_Rm91uKSvAFSWySByannT7aFk1D/view?usp=sharing', 7),
	(94, 'OPCUA-自動化溫室', '628df53ce3df7', 'http://ce.ntpu.edu.tw/images/Screenshot 2022-05-25 170559.png', 'https://drive.google.com/file/d/1mTa42TCTf2DyFmeJeAssaVYm-Ruxl9eC/view?usp=sharing', 7),
	(95, 'Wi-Fi監測智慧自動水族箱', '628df551f1408', 'http://ce.ntpu.edu.tw/images/Screenshot 2022-05-25 170634.png', 'https://drive.google.com/file/d/1WtObTeUXEjd_EtdR0Rl4yftl18W6QGU0/view?usp=sharing', 7);
...
CREATE TABLE IF NOT EXISTS `ga_topic` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Here record topic for ga_item to group same topic events.';
...
CREATE TABLE IF NOT EXISTS `post` (
  ...
  `href` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=92 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='If ''href'' is not NULL, it redirect to the url. ';

-- 正在傾印表格  ntpuce.post 的資料：~79 rows (近似值)
...
INSERT INTO `post` (`id`, `title`, `class`, `enable`, `content`, `published`, `href`) VALUES
	...
	(72, '110學年度通訊工程學系「專題製作」說明會', 13, 1, '626f887d09bc1', '2022-05-02 07:30:05', NULL),
	(75, '【代轉】正崴精密工業股份有限公司_徵才訊息', 10, 1, '627e1121c4dfd', '2022-05-13 08:04:49', NULL),
	(77, '【代轉】千如電機股份有限公司高薪禮聘RF電路研發工程師', 10, 1, '627e12ee35abf', '2022-05-13 08:12:30', NULL),
	...
	(84, '國立臺北大學通訊工程學系110學年度第2學期專題競賽活動公告', 13, 1, '6282ff557398f', '2022-05-17 01:50:13', NULL),
	(85, '專題研討(111/05/27)－黃彥銘博士(創未來科技股份有限公司/主任工程師)', 13, 1, '628b1e6c646a8', '2022-05-23 05:41:00', NULL),
	(86, '110學年度第2學期音律電子股份有限公司清寒暨優秀獎學金獲獎同學名單', 11, 1, '62a042e058758', '2022-06-08 06:34:08', NULL),
	(88, '國立臺北大學通訊工程學系110學年度第2學期專題競賽活動Microsoft teams連結', 13, 1, '62b42dfbbeb50', '2022-06-23 09:10:19', NULL),
	(89, '國立臺北大學通訊工程學系110學年度第2學期專題競賽活動獲獎名次', 13, 1, '62b58d140722c', '2022-06-24 10:08:20', NULL),
	(90, '徵聘教師公告_助理教授職級(含)以上約聘教學人員1名（起聘日期：中華民國112年2月1日）', 11, 1, '62c28831ef078', '2022-07-04 06:26:57', NULL),
	(91, '臺北大學企管系黃美綺老師的徵才訊息', 10, 1, '62ec8e273f75a', '2022-08-05 03:27:35', NULL);
